...
from groundguard.models.result import Source, VerificationResult  # noqa: E402
from groundguard.exceptions import VerificationFailedError  # noqa: E402
...
def test_on_chain_end_extracts_source_documents_as_source_objects(mocker):
    ...
    mock_verify = mocker.patch(
        "groundguard.integrations.langchain.verify",
